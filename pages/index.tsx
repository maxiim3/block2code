    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Code2Block is a web app that splits code into blocks of 6000 chars. Input code, select language, & minify before creating blocks." />
                <meta property="og:title" content="My Page" />
                <meta property="og:description" content="Code2Block is a web app that splits code into blocks of 6000 chars. Input code, select language, & minify before creating blocks." />
                <meta property="og:image" content="/assets/preview-xl.png" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="628" />
                <meta property="og:image" content="/assets/preview-lg.png" />
                <meta property="og:image:width" content="600" />
                <meta property="og:image:height" content="314" />
                <meta property="og:image" content="/assets/preview-sm.png" />
                <meta property="og:image:width" content="300" />
                <meta property="og:image:height" content="157" />
                <meta property="og:url" content="https://code2block.vercel.app/" />
                <meta property="og:type" content="website" />
                <meta property="article:author" content="Maxime Tamburrini" />
            ...
            <div
                className="flex h-full min-h-screen flex-col items-center bg-[#0E1117] px-4 pb-20 text-neutral-200 sm:px-10">
                ...
                {minifiedCode && blocks.length > 0 && !loading && hasProcessed && (
                    <>
                        ...
                        <div
                            className="mt-6 flex w-full max-w-[1200px] flex-col justify-between sm:flex-row sm:flex-wrap">
                            {blocks.map((block, _i) => (
                                <div
                                    key={_i}
